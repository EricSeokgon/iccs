...
function fn_company_popup(){
	var path = "../usebefore/UseBeforeAction.do?cmd=UseBeforeRegInfo&str=<%=COI_WRT_NUM%>";
			...
			<div id="contents" >
				<form name=fmParam method="post" action="../usebefore/UseBeforeAction.do" >
					...
					<table width="100%"  border="0" cellspacing="0" cellpadding="3" class="inputta" id="tab1">
						<tr onClick="fn_company_popup()" style="cursor:hand">
							...
							<td colspan="8">
								<table width="100%" border="0" cellspacing="0" cellpadding="3" class="inputTable" >
									<tr>
										...
										<th class="line" width="20%" style="border-top:1px solid #448fd0;">검사일</th>
										<td class="line" style="border-top:1px solid #448fd0;">
										...
										<%="3".equals(NAPPL_YN)?"":"<img src='../images/box/approval.gif' onClick='fn_GroupWare();' align='absmiddle' style='cursor:hand' >"%>
										</th>									
									</tr>
									<tr>
										...
										<th class="line" width="20%" >필증교부번호 </th>
										<td class="line" >
