...
<%
  ...
  String mode 			= KJFUtil.print(request.getParameter("mode"));
	...
	String COI_WRT_NUM				= KJFUtil.print(rEntity.getValue(0,"COI_WRT_NUM"),""); // 공사업등록번호
...
function fn_company_popup(){
	...
	if (str != ""){
		...
		//centerwin(path,"공사업조회", "620", "600","yes");
   		...
   		<div id="sub_contents"><a name="contents"></a>
			...
			<div id="contents" >
				<form name=fmParam method="post" action="../usebefore/UseBeforeAction.do" >
					...
					<input type="hidden" name="cmd" value="UseBeforeMgrResCUD" />
					...
					<table width="100%"  border="0" cellspacing="0" cellpadding="3" class="inputta" id="tab1">
						<tr >
							...
							<td class="line" width="18%"><%=CIV_RECV_NUM%><input name="CIV_RECV_NUM" type="hidden" size="17" id="CIV_RECV_NUM" value="<%=CIV_RECV_NUM%>"></td>
							<th class="line" width="11%">시공업체</th>
							<td class="line" width="23%" >
							<%=OPE_NAME%> &nbsp;&nbsp;<img src="../images/common/btn_view.gif" onClick="fn_company_popup()" style="cursor:hand"/>
							<input name="OPE_NAME" type="hidden" size="15" id="OPE_NAME" value="<%=OPE_NAME%>">
							</td>
						...
						<tr>
							...
							<td class="line" width="18%"><%=INSP_SPOT_NM%><input name="INSP_SPOT_NM" type="hidden" size="17" id="INSP_SPOT_NM" value="<%=INSP_SPOT_NM%>"></td>
						...
						<tr>
							<td colspan="8">
								<table width="100%" border="0" cellspacing="0" cellpadding="3" class="inputTable" >
									<tr>
										<th class="line" width="17%" style="border-top:1px solid #448fd0;">검사결과<br/> 최종의견</th>
					...
					<table width="100%"  border="0" cellspacing="0" cellpadding="3" class="inputTable" id="tab3" style="display:none;">
						<tr>
					      	<td >
													<iframe title="사용전검상 첨부파일" src="../usebefore/UseBeforeAction.do?cmd=UseBeforeAttMgr&scRECV_NUM=<%=pm.getScRecv_num()%>" width="100%" height="300" frameborder=0 style="border: 1px solid #cccccc"></iframe>		      	
					      	</td>
					  </tr>					  
					</table>
					<!-- ======================== [TAB3] 추가속성 END =========================== -->
