       ...
       <tr>
         <td width="245" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
           ...
           <tr>
             <td style="padding-left:10px;"><table border="0" cellspacing="0" cellpadding="0">
               ...
               <tr>
                 <td><a href="javascript:go_bbs('BOD_DATA_4');" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('3m4','','../tongsin/images/sub/left_menu34_on.gif',1)"><img src="../tongsin/images/sub/left_menu34_on.gif" alt="최근IT소식" name="3m4" width="195" height="31" border="0"></a></td>
               </tr>
               <tr>
         ...
         <td valign="top"><table width="690" border="0" cellspacing="0" cellpadding="0">
           ...
           <tr>
             <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
               <tr>
                 <td><img src="../tongsin/images/sub/title34.gif" alt="최근IT소식" width="95" height="20"></td>
