       ...
       <tr>
         <td width="245" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
           ...
           <tr>
             <td style="padding-left:10px;"><table border="0" cellspacing="0" cellpadding="0">
               ...
               <tr>
                 <td><a href="javascript:go_bbs('BOD_DATA_2');" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('3m2','','../tongsin/images/sub/left_menu32_on.gif',1)"><img src="../tongsin/images/sub/left_menu32_on.gif" alt="동영상자료" name="3m2" width="195" height="31" border="0"></a></td>
               </tr>
               <tr>
         ...
         <td valign="top"><table width="690" border="0" cellspacing="0" cellpadding="0">
           ...
           <tr>
             <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
               <tr>
                 <td><img src="../tongsin/images/sub/title32.gif" alt="동영상자료" width="94" height="20"></td>
                 <td align="right"><a href="/">HOME</a>  &gt; 자료실 &gt; 동영상자료 </td>
               </tr>
             </table></td>
           </tr>
           <tr>
