       ...
       <tr>
         <td width="245" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
           ...
           <tr>
             <td style="padding-left:10px;"><table border="0" cellspacing="0" cellpadding="0">
               <tr>
                 <td><a href="javascript:go_bbs('BOD_JOIN_01');" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('5m1','','../tongsin/images/sub/left_menu51_on.gif',1)"><img src="../tongsin/images/sub/left_menu51.gif" alt="업무연락" name="5m1" width="195" height="31" border="0"></a></td>
               </tr>
               <tr>
                 <td><a href="javascript:go_bbs('BOD_JOIN_02');" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('5m2','','../tongsin/images/sub/left_menu52_on.gif',1)"><img src="../tongsin/images/sub/left_menu52_on.gif" alt="소식지" name="5m1" width="195" height="31" border="0"></a></td>
               </tr>
         ...
         <td valign="top"><table width="690" border="0" cellspacing="0" cellpadding="0">
           ...
           <tr>
             <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
               <tr>
                 <td><img src="../tongsin/images/sub/title52.gif" alt="소식지" width="55" height="20"></td>
