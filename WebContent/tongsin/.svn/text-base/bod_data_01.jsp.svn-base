       ...
       <tr>
         <td width="245" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
           ...
           <tr>
             <td style="padding-left:10px;"><table border="0" cellspacing="0" cellpadding="0">
               <tr>
                 <td><a href="javascript:go_bbs('BOD_DATA_1');" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('3m1','','../tongsin/images/sub/left_menu31_on.gif',1)"><img src="../tongsin/images/sub/left_menu31_on.gif" alt="연구관련자료" name="3m1" width="195" height="31" border="0"></a></td>
               </tr>
               <tr>
         ...
         <td valign="top"><table width="690" border="0" cellspacing="0" cellpadding="0">
           ...
           <tr>
             <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
               <tr>
                 <td><img src="../tongsin/images/sub/title31.gif" alt="연구관려자료" width="111" height="20"></td>
