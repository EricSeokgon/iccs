       ...
       <tr>
         <td width="245" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
           ...
           <tr>
             <td style="padding-left:10px;"><table border="0" cellspacing="0" cellpadding="0">
               ...
               <tr>
                 <td><a href="javascript:go_bbs('BOD_DATA_3');" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('3m3','','../tongsin/images/sub/left_menu33_on.gif',1)"><img src="../tongsin/images/sub/left_menu33_on.gif" alt="교육강의자료" name="3m3" width="195" height="31" border="0"></a></td>
               </tr>
               <tr>
         ...
         <td valign="top"><table width="690" border="0" cellspacing="0" cellpadding="0">
           ...
           <tr>
             <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
               <tr>
                 <td><img src="../tongsin/images/sub/title33.gif" alt="교육강의자료" width="112" height="20"></td>
