       ...
       <tr>
         <td width="245" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
           ...
           <tr>
             <td style="padding-left:10px;"><table border="0" cellspacing="0" cellpadding="0">
               ...
               <tr>
                 <td><a href="javascript:go_bbs('BOD_DATA_5');" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('3m5','','../tongsin/images/sub/left_menu35_on.gif',1)"><img src="../tongsin/images/sub/left_menu35.gif" alt="ubiquitous" name="3m5" width="195" height="31" border="0"></a></td>
               </tr>
               <tr>
               ...
               <tr>
                 <td><a href="javascript:go_bbs('BOD_DATA_7');" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('3m7','','../tongsin/images/sub/left_menu37_on.gif',1)"><img src="../tongsin/images/sub/left_menu37_on.gif" alt="IT연수보고자료" name="3m7" width="195" height="31" border="0"></a></td>
               </tr>
         ...
         <td valign="top"><table width="690" border="0" cellspacing="0" cellpadding="0">
           ...
           <tr>
             <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
               <tr>
                 <td><img src="../tongsin/images/sub/title37.gif" alt="IT연수보고자료" width="127" height="20"></td>
