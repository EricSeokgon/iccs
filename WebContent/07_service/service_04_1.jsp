...
<html lang="ko">
<head>
<title>이메일주소무단수집 거부 페이지입니다.</title>
	...
	<div id="body">
		...
		<!-- 중간컨텐츠 : S -->
   		<div id="sub_contents"><a name="contents"></a>
			...
			<div id="con_head">
				<p class="position">
					<a href="../"><img src="../images/common/icon_home.gif" alt="HOME"></a> 이용안내 | 이메일주소무단수집거부
				</p>
			</div>
			<!-- 현재위치 : E -->
			...
			<!-- 서브타이틀 : S -->
			<div id="sub_title">
				<h3 class="cont01"><img src="../07_service/images/titile_04_1.gif" alt="이메일주소무단수집 거부"></h3>
			</div>
			<!-- 서브타이틀 : E -->
