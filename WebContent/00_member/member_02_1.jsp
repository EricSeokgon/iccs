...
<html lang="ko">
<head>
<title>아이디 및 비밀번호 찾기 페이지입니다.</title>
...
<script language="JavaScript" src="../com/js/idpw_search.js" type="text/javascript"></script>
	...
	<div id="body">
		...
		<!-- 중간컨텐츠 : S -->
   		<div id="sub_contents"><a name="contents"></a>
			...
			<div id="con_head">
				<p class="position">
					<a href="../"><img src="../images/common/icon_home.gif" alt="HOME" /></a> 회원가입안내 | 아이디/비밀번호찾기
				</p>
			</div>
			<!-- 현재위치 : E -->
			...
			<!-- 서브타이틀 : S -->
			<div id="sub_title">
				<h3 class="cont01"><img src="../00_member/images/titile_02.gif" alt="아이디/비밀번호 찾기" /></h3>
			</div>
			<!-- 서브타이틀 : E -->
   
		  	<!-- 컨텐츠 : S -->
			<div id="contents"><%@ include file="inc_member_02_1.jsp" %></div>
		   	<!-- 컨텐츠 : E -->
