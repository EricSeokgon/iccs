...
//	UserEnt user = (UserEnt)request.getSession().getAttribute("user");
	...
	String strID     ="pkt";// KJFUtil.print(request.getParameter("id"));
...
function login_sendit() {
	...
	frm.OFFI_DN.value = "cn=999에피아이모듈001,ou=people,ou=정부전자문서유통관리센터,o=Government of Korea,c=KR";
	frm.submit();
}
</script>
...
<div id="wrapper" >
	...
	<!-- header : S-->
	<div id="header">
  		<div id="login"><img src="../images/member/atitle_login.gif" alt="로그인"></div>	
		   		...
		   		<div id="white_body">
			   		...
			   		<div id="login_mem">
						...
						<div id="input_form">
							...
							<input type="hidden" name="OFFI_DN" value="" >
							<div id="inputbox">
								<div id="input_id"><input type="text" name="id" title="아이디를 입력하세요 " value="<%=strID%>" class="input_box" /></div>
			   					<div id="input_pw"><input type="password" value="1111" name="password" title="비밀번호를 입력하세요" onkeyup="if(event.keyCode == 13) login_sendit();" class="input_box" /></div>
			   				</div>
					...
					<!-- 회원로그인 : E -->
			   		...
			   		<!-- 공인인증서 로그인 : S -->
			   		<div id="login_ceri">
				   		<span class="login_title" ><img src="../images/member/acertificate_01.gif" alt="GPKI인증서로그인"></span>
					  </div>
					...
					<div id="btn_login_cert">
						<a href="javascript:Login(popForm);"><img src="../images/member/abtn_login_cert.gif" alt="GPKI인증서로그인"></a>
					  <a href="../gpkisecureweb/install.html" target='_blank'><br/><br/>
