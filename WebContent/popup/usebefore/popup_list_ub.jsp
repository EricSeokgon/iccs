...
<body>
	...
	<div id="popup_use">
		...
		<div id="popup_contents_use">
				...
				<input type="hidden" name="cmd" value="UseBeforeQuickSigun">
				<input type="hidden" name="getCode" value="<%=pm.getScSIGUNGU_CODE()%>">
				...
				<table class="t2" summary="번호 접수번호 신청인 시공업체 현장명칭 접수일자 진행상태를 나타내는 표">
				    ...
				    <tbody>
						...
						%>
							<tr>
					        <td align="center" class="letter0"><%=civ_recv_num %></td>
							    ...
							    <td align="center" class="letter0"><%=KJFUtil.print(rEntity.getValue(i, "INSP_SPOT_ADDR"))+KJFUtil.print(rEntity.getValue(i, "INSP_SPOT_DETAILADDR")) %></td>
									...
									<td align="center" class="letter0"><%=KJFUtil.print(proc_ste)%></td>
							</tr>
							<% } %>
						<% } else { %>
							<tr>
