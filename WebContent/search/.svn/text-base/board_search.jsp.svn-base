	...
	<div id="body">
	  	...
	  	<!-- 중간컨텐츠 : S -->
   		<div id="pull_contents"><a name="contents"></a>
			...
			<div id="con_head">
				<p class="position">
					<a href="../"><img src="../images/common/icon_home.gif" alt="HOME" /></a> 통합검색 | 게시물 검색
				</p>
			</div>
			<!-- 현재위치 : E -->
			...
			<div id="tab">
				<ul>
					...
					<li class='tab_title'><img src="../images/search/tab_notice_over.gif" alt="게시물 검색"></li>
			...
			<input type="hidden" name="cmd"	value="BoardSearch">
				...
				<li class='p10'>
					...
					<div id="search_page">
						<div class="search_list_01">
							<span class='search_list_text'>게시물 검색  - <span class="font_orange"><%=KJFUtil.print(pm.getTotalCount(), "0")%></span> 건</span>
								...
								<% for(int i = 0; i < xmllist.size(); i++) {  %>
									...
									<li class="list_style2">
										...
										<ul class="detail_style1">
											...
											<li class="page_url1">http://www.ics.net.go.kr/bbs/BbsAction.do?cmd=BbsKView&CT_ID=<%=KJFUtil.print(scBean.getCt_id())%>&BOARD_SEQ=<%=KJFUtil.print(scBean.getBoard_seq())%></li>
										</ul>
									</li>
								<% } %>
