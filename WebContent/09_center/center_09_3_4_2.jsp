...
function fn_goList(){
    ...
    fm.action = "../illegality/IllegalityAction.do?cmd=IllWarningList";
    fm.method = "post";
		...
		<!-- 중간컨텐츠 : S -->
   		<div id="sub_contents"><a name="contents"></a>
			...
			<div id="contents">
				...
				<input type="hidden" name="cmd"        value="IllWarningView">		
			...
			<!--경고조치 : S -->
				...
				<table class="t2" summary="">
				    ...
				    <tbody>
				        <tr>
				            <th>경고일자</th>
				            <td class="letter0"><%=KJFUtil.print(KJFDate.getChangDatePattern(rEntity.getValue(0, "WARN_DT"), "yyyyMMdd", "yyyy/MM/dd"), "&nbsp;") %></td>
				        </tr>
				        <tr>
				            <th>경고내용</th>
				            <td><%=KJFUtil.print(rEntity.getValue(0, "WARN_CONT"), "&nbsp;") %></td>
				        </tr>
				    </tbody>
				</table>
				<!--시정명령내용 : E -->
