...
function fn_goList(){
    ...
    fm.action = "../illegality/IllegalityAction.do?cmd=IllCorOrderList";
    fm.method = "post";
		...
		<!-- 중간컨텐츠 : S -->
   		<div id="sub_contents"><a name="contents"></a>
			...
			<div id="contents">
				...
				<input type="hidden" name="cmd"        value="IllCorOrderView">		
				...
				<table class="t2" summary="">
				    ...
				    <tbody>
				        <tr>
				            <th>시정기간</th>
				            <td class="letter0">
								<%=KJFUtil.print(KJFDate.getChangDatePattern(rEntity.getValue(0, "CORRECT_ORDER_START_DT"), "yyyyMMdd", "yyyy/MM/dd"), "&nbsp;") %> ~
								<%=KJFUtil.print(KJFDate.getChangDatePattern(rEntity.getValue(0, "CORRECT_ORDER_END_DT"), "yyyyMMdd", "yyyy/MM/dd"), "&nbsp;") %>
							</td>
				        </tr>
				        <tr>
				            <th>시정내용</th>
				            <td><%=KJFUtil.print(rEntity.getValue(0, "CORRECT_ORDER_CONT"), "&nbsp;") %></td>
				        </tr>
				    </tbody>
				</table>
				<!--시정명령내용 : E -->
