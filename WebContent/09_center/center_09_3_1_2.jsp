...
function fn_goList(){
    ...
    fm.action = "../illegality/IllegalityAction.do?cmd=IllBusiSusList";
    fm.method = "post";
			...
			<div id="contents">
				...
				<table class="t2" summary="">
				    ...
				    <tbody>
				    	...
				    	<tr>
				            <th>영업정지기간</th>
				            <td class="letter0"><%=KJFUtil.print(KJFDate.getChangDatePattern(rEntity.getValue(0, "BUSISUSP_START_DT"), "yyyyMMdd", "yyyy/MM/dd"), "&nbsp;") %> ~ <%=KJFUtil.print(KJFDate.getChangDatePattern(rEntity.getValue(0, "BUSISUSP_END_DT"), "yyyyMMdd", "yyyy/MM/dd"), "&nbsp;") %></td>
				        </tr>
				        <tr>
				            <th>행정처분사유</th>
				    ...
				    <tbody>
						<% if (reportEntity.getRowCnt() > 0 ) {%>
							...
							<tr>
					            ...
					            <td align="center" class="letter0"><%=KJFUtil.print(KJFDate.getChangDatePattern(reportEntity.getValue(0, "SEND_DT"), "yyyyMMdd", "yyyy/MM/dd"), "&nbsp;") %></td>
							    <td align="center" class="letter0"><%=KJFUtil.print(KJFDate.getChangDatePattern(reportEntity.getValue(0, "PROC_LIM"), "yyyyMMdd", "yyyy/MM/dd"), "&nbsp;") %></td>
