...
function viewDetail(tmp_wrt_num, wrt_num) {
    ...
    fm.action = "../illegality/IllegalityAction.do?cmd=IllBusiSusView";
	...
	<div id="body">
		...
		<!-- 중간컨텐츠 : S -->
   		<div id="sub_contents"><a name="contents"></a>
			...
			<div id="con_head">
				<p class="position">
					<a href="../"><img src="../images/common/icon_home.gif" alt="HOME"></a> 원스톱민원센타 | 위법관리 | 영업정지
				</p>
			</div>
			<!-- 현재위치 : E -->
			...
			<!-- 서브타이틀 : S -->
			<div id="sub_title">
				<h3 class="cont01"><img src="../09_center/images/titile_09_3_1.gif" alt="영업정지"></h1>
			</div>
			<!-- 서브타이틀 : E -->
			...
			<div id="contents">
				...
				<input type="hidden" name="cmd" value="IllBusiSusList">		
				    ...
				    <tbody>
						...
						<% if (rEntity.getRowCnt() > 0 ) {%>
							...
							<tr>
						            ...
						            <td align="center" class="letter0"><%=KJFDate.getChangDatePattern(rEntity.getValue(i, "VIOL_DT"), "yyyyMMdd", "yyyy/MM/dd") %></td>
								    <td align="center"><a href="javascript:viewDetail('<%=rEntity.getValue(i, "TMP_WRT_NUM")%>','<%=rEntity.getValue(i, "WRT_NUM")%>')"><%=KJFUtil.print(rEntity.getValue(i, "VIOL_CONT")) %></a></td>
								    <td align="center" class="letter0"><%=KJFDate.getChangDatePattern(rEntity.getValue(i, "DISPO_DT"), "yyyyMMdd", "yyyy/MM/dd") %></td>
								    <td align="center" class="letter0"><%=KJFDate.getChangDatePattern(rEntity.getValue(i, "BUSISUSP_START_DT"), "yyyyMMdd", "yyyy/MM/dd") %></td>
									<td align="center" class="letter0"><%=KJFDate.getChangDatePattern(rEntity.getValue(i, "BUSISUSP_END_DT"), "yyyyMMdd", "yyyy/MM/dd") %></td>
									<td align="center"><%=KJFUtil.print(rEntity.getValue(i, "MOT_STE_NM")) %></td>
							</tr>
							<% } %>
						<% } else { %>
							<tr>
