...
function fn_goList(){
    ...
    fm.action = "../illegality/IllegalityAction.do?cmd=IllProsecutionList";
    fm.method = "post";
	...
	<div id="body">
		...
		<!-- 중간컨텐츠 : S -->
   		<div id="sub_contents"><a name="contents"></a>
			...
			<!-- 서브타이틀 : S -->
			<div id="sub_title">
				<h3 class="cont01"><img src="../09_center/images/titile_09_3_6.gif" alt="형사고발"></h1>
			</div>
			<!-- 서브타이틀 : E -->
			...
			<input type="hidden" name="cmd"        value="IllProsecutionView">	
			...
			<!--형사고발 : S -->
				...
				<table class="t2" summary="">
				    ...
				    <tbody>
				    	<tr>
				            <th>형사고발처</th>
				            <td><%=KJFUtil.print(rEntity.getValue(0, "PRSEC_PART"), "&nbsp;") %></td>
				        </tr>
				        <tr>
				            <th>고발일자</th>
				            <td class="letter0"><%=KJFUtil.print(KJFDate.getChangDatePattern(rEntity.getValue(0, "PRSEC_DT"), "yyyyMMdd", "yyyy/MM/dd"), "&nbsp;") %></td>
				        </tr>
				        <tr>
				            <th>고발내용</th>
				            <td><%=KJFUtil.print(rEntity.getValue(0, "PRSEC_CONT"), "&nbsp;") %></td>
				        </tr>
				    </tbody>
				</table>
				<!--형사고발내용 : E -->
