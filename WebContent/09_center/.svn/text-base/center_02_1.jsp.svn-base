...
<meta http-equiv="imagetoolbar" content="no">
	...
	<script src="../flash/flash_pub.js" type="text/javascript"></script>
	<!-- 공통 : E -->
	<script>
	function fn_info(){
		var path = "../images/common/image05_01_01.gif";
		winOpenAtCenter(path, '입법절차안내',  "700", "700","yes");
	}
	</script>
</head>
	...
	<div id="body">
		...
		<!-- 중간컨텐츠 : S -->
   		<div id="sub_contents"><a name="contents"></a>
			...
			<div id="con_head">
				<p class="position">
					<a href="../"><img src="../images/common/icon_home.gif" alt="HOME" /></a> 공무원센터     |  법·제도     |  법령 제·개정
				</p>
			</div>
			<!-- 현재위치 : E -->
			...
			<!-- 서브타이틀 : S -->
			<div id="sub_title">
				<h3 class="cont01"><img src="../09_center/images/titile_02_1.gif" alt="법령 제·개정" />
				<img src="../09_center/images/btn_guide.gif" alt="입법절차안내" onClick="fn_info()" style="cursor:hand" /></h3>
			</div>
			<!-- 서브타이틀 : E -->
