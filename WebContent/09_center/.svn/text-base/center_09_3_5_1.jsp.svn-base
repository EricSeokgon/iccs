...
function viewDetail(tmp_wrt_num, wrt_num) {
    ...
    fm.action = "../illegality/IllegalityAction.do?cmd=IllCorOrderView";
	...
	<div id="body">
		...
		<!-- 중간컨텐츠 : S -->
   		<div id="sub_contents"><a name="contents"></a>
			...
			<div id="con_head">
				<p class="position">
					<a href="../"><img src="../images/common/icon_home.gif" alt="HOME"></a> 원스톱민원센타 | 위법관리 | 시정명령
				</p>
			</div>
			<!-- 현재위치 : E -->
			...
			<!-- 서브타이틀 : S -->
			<div id="sub_title">
				<h3 class="cont01"><img src="../09_center/images/titile_09_3_5.gif" alt="시정명령"></h1>
			</div>
			<!-- 서브타이틀 : E -->
			...
			<div id="contents">
				...
				<input type="hidden" name="cmd" value="IllCorOrderList">		
				    ...
				    <tbody>
						...
						<% if (rEntity.getRowCnt() > 0 ) {%>
							...
							<tr>
								    ...
								    <td align="center"><a href="javascript:viewDetail('<%=rEntity.getValue(i, "TMP_WRT_NUM")%>','<%=rEntity.getValue(i, "WRT_NUM")%>')"><%=KJFUtil.getTitleLimit(KJFUtil.print(rEntity.getValue(i, "CORRECT_ORDER_CONT")), 50) %></a></td>
								    <td align="center" class="letter0"><%=KJFUtil.print(KJFDate.getChangDatePattern(rEntity.getValue(i, "CORRECT_ORDER_START_DT"), "yyyyMMdd", "yyyy/MM/dd"), "&nbsp;") %></td>
								    <td align="center" class="letter0"><%=KJFUtil.print(KJFDate.getChangDatePattern(rEntity.getValue(i, "CORRECT_ORDER_END_DT"), "yyyyMMdd", "yyyy/MM/dd"), "&nbsp;") %></td>
