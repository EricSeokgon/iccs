	...
	<div id="body">
		...
		<!-- 중간컨텐츠 : S -->
   		<div id="sub_contents"><a name="contents"></a>
			...
			<div id="con_head">
				<p class="position">
					<a href="../"><img src="../images/common/icon_home.gif" alt="HOME" /></a> | 커뮤니티 | FAQ | 사용전검사/착공전설계도확인
				</p>
			</div>
			<!-- 현재위치 : E -->
			...
			<div id="contents">
				...
				<div id="faq_tab">
					<ul>
						...
						<li class='open'>사용전검사/착공전설계도확인</li>
						<li><a href="../bbs/BbsAction.do?cmd=BbsKList&CT_ID=FAQ_HOM">홈페이지관련</a></li>
						<li><a href="../search/SearchAction.do?cmd=FaqUnifiedSearch">FAQ통합검색</a></li>
					</ul>	
				</div>
				<!-- tab : E -->
				
				<%@include file="../bbs/BbsK.jsp"%></div>
		   	<!-- 컨텐츠 : E -->
