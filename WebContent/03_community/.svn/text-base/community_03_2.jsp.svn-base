	...
	<div id="body">
		...
		<!-- 중간컨텐츠 : S -->
   		<div id="sub_contents"><a name="contents"></a>
			...
			<div id="con_head">
				<p class="position">
					<a href="../"><img src="../images/common/icon_home.gif" alt="HOME" /></a> 커뮤니티 | 공사업공고 | 공사업변경사항공고
				</p>
			</div>
			<!-- 현재위치 : E -->
			...
			<!-- 서브타이틀 : S -->
			<div id="sub_title">
				<h3 class="cont01"><img src="../03_community/images/titile_03_2.gif" alt="공사업 변경사항 공고" /></h3>
			</div>
			<!-- 서브타이틀 : E -->
