	...
	<div id="body">
		...
		<!-- 중간컨텐츠 : S -->
   		<div id="sub_contents"><a name="contents"></a>
			...
			<!-- 서브타이틀 : S -->
			<div id="sub_title">
				<h3 class="cont01"><img src="../06_mystore/images/titile_06_1.gif" alt="공인인증서재등록"></h3>
			</div>
			<!-- 서브타이틀 : E -->
		  	...
		  	<!-- 컨텐츠 : S -->
	  	  	<div id="contents">
				<!-- 공인인증서 재등록 : S -->
				<h4><img src="../06_mystore/images/sub_title_05_1.gif" alt="공인인증서란?"></h4>
				<p class="txt">
				...
				<h4><img src="../06_mystore/images/sub_title_05_2.gif" alt="이용안내"></h4>
				<div id="orange_650">
					<p class="txt">
				...
				<div class="center">
					<%if(user.getCAPITAL().equals("E")) { %>
						<a href="javascript:enterpriseReEnroll()"><img src="../06_mystore/images/btn_cert_re.gif" alt="공인인증서 재등록"></a>
					<% }  else { %>
						<a href="javascript:individualReEnroll()"><img src="../06_mystore/images/btn_cert_re.gif" alt="공인인증서 재등록"></a>
					<% } %>	
