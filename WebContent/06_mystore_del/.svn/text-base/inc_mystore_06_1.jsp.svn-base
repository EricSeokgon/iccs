...
<h4><img src="../06_mystore/images/sub_title_05_1.gif" alt="회원탈퇴안내" /></h4>
<p class="txt">아래 회원탈퇴 관련사항을 확인하시고 회원탈최하기 버튼을 클릭하시면 회원탈퇴 처리가 완료됩니다.</p>
<h4><img src="../06_mystore/images/sub_title_05_2.gif" alt="회원탈퇴 관련사항" /></h4>
<div id="orange_650">
...
<div class="padd15">
  <dl>
    <dt class="arrow05">본인확인제란?</dt>
	  <dd>이용자가 게시판에 정보를 게시하려고 할 경우 해당 게시판 관리·운영자가 이용자의 본인여부를 확인하는 제도로써 <br>
...
인터넷 이용문화 바로세움, 명예훼손분쟁조정, 민·형사상 소제기시 가해자 정보제공으로 피해자를 구제하기 위한 것입니다. 
    <p class="sfont_gray66"><strong>근거 : 정보통신망 이용촉진 및 정보보호 등에 관한 법률</strong><p> </dd>
  </dl>
</div> 
