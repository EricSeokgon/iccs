	...
	<div id="body">
		...
		<!-- 중간컨텐츠 : S -->
   		<div id="sub_contents"><a name="contents"></a>
			...
			<!-- 서브타이틀 : S -->
			<div id="sub_title">
				<h3 class="cont01"><img src="../06_mystore/images/titile_05_1.gif" alt="공인인증서재등록"></h3>
			</div>
			<!-- 서브타이틀 : E -->
		  	...
		  	<!-- 컨텐츠 : S -->
				...
				<h4><img src="../06_mystore/images/sub_title_04_1.gif" alt="모바일 서비스란?"></h4>
				<p class="txt">
				...
				<!--인증번호 입력 : S  -->
				<h4><img src="../06_mystore/images/sub_title_04_4.gif" alt="모바일 서비스 신청완료"></h4>
				<div id="orange_650">
					<p class="txt center" style="padding: 20px 0 5px 0;"> <strong>모바일 서비스 사용신청</strong>이 <span class="font_orangeB">완료</span>되었습니다.</p>
