	...
	<div id="body">
		...
		<!-- 중간컨텐츠 : S -->
   		<div id="sub_contents"><a name="contents"></a>
			...
			<!-- 서브타이틀 : S -->
			<div id="sub_title">
				<h3 class="cont01"><img src="../06_mystore/images/titile_05_1.gif" alt="모바일 서비스 사용신청"></h3>
			</div>
			<!-- 서브타이틀 : E -->
		  	...
		  	<!-- 컨텐츠 : S -->
				...
				<% if ( KJFUtil.print(rEntity.getValue(0, "USER_MOBILE_YN")).equals("Y") ) { %>
					<!-- 신청하기 : S -->
					<h4><img src="../06_mystore/images/sub_title_04_2.gif" alt="모바일 서비스 신청하기"></h4>
					<div id="orange_650">
				...
				<% } else { %>
					...
					<!-- 인증번호 입력 : S -->
					<h4><img src="../06_mystore/images/sub_title_04_3.gif" alt="인증번호 입력"></h4>
					<div id="orange_650">
						<div class="mobile_form">
							<label for="user_name">
