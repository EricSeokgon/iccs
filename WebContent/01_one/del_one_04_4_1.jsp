...
function viewDetail(tmp_wrt_num, wrt_num) {
    ...
    fm.action = "../illegality/IllegalityAction.do?cmd=IllNegFineView";
	...
	<div id="body">
		...
		<!-- 중간컨텐츠 : S -->
   		<div id="sub_contents"><a name="contents"></a>
			...
			<!-- 서브타이틀 : S -->
			<div id="sub_title">
				<h3 class="cont01"><img src="../01_one/images/titile_04_4.gif" alt="과태료부과"></h1>
			</div>
			<!-- 서브타이틀 : E -->
				    ...
				    <tbody>
						...
						<% if (rEntity.getRowCnt() > 0 ) {%>
							...
							<tr>
								    ...
								    <td align="center"><a href="javascript:viewDetail('<%=rEntity.getValue(i, "TMP_WRT_NUM")%>','<%=rEntity.getValue(i, "WRT_NUM")%>')"><%=KJFUtil.getTitleLimit(KJFUtil.print(rEntity.getValue(i, "DISPO_CAUSE")), 50) %></a></td>
								    <td align="center" class="letter0"><%=KJFUtil.money(KJFUtil.str2long(rEntity.getValue(i, "NEFI"))) %></td>
								    <td align="center" class="letter0"><%=KJFUtil.print(KJFDate.getChangDatePattern(rEntity.getValue(i, "PAY_LIM"), "yyyyMMdd", "yyyy/MM/dd"), "&nbsp;") %></td>
