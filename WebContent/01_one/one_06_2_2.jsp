	...
	<div id="body">
		...
		<!-- 중간컨텐츠 : S -->
   		<div id="sub_contents"><a name="contents"></a>
			...
			<!-- 서브타이틀 : S -->
			<div id="sub_title">
				<h3 class="cont01"><img src="../01_one/images/titile_06_2.gif" alt="개인정보수정"></h3>
			</div>
			<!-- 서브타이틀 : E -->
			...
			<div id="contents">
				<!--개인정보 변경 : S  -->
					<div class="padd15"><h4><img src="../01_one/images/sub_title_02_3.gif" alt="개인정보 변경완료"></h4></div>
					<div id="orange_650">
						<p class="txt center" style="padding: 20px 0 5px 0;"> <strong>개인정보 수정</strong>이  <span class="font_orangeB">완료</span>되었습니다.<br />
						수정된 정보를 이용하시려면 <span class="font_orangeB">재로그인</span>을 하셔야 합니다.</p>
						<div id="orange_650_bt" ></div>	
					</div>	
					<!-- 개인정보 변경 : E -->
					<!-- 버튼 : S -->
					<div class="center">
						<a href="../mem/MemAction.do?cmd=MemInfoV"><img src="../images/btn/btn_modify_ok.gif" alt="수정 확인"></a>
