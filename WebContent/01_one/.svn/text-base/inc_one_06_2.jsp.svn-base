		...
		<div id="com_input" class="line_T2B1">
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
			  ...
			  <tr>
				...
				<td class="td_view_detail">
					<input name="office_post_num" type="text" value="<%=KJFUtil.print(rEntity.getValue(0, "OFFICE_POST_NUM"))%>" size="8" maxlength="7" title="소재지 우편번호를 입력해주세요" >
			  ...
			  <tr>
				...
				<td class="td_view_detail"><input name="office_addr" type="text" value="<%=KJFUtil.print(rEntity.getValue(0, "OFFICE_ADDR"))%>" size="40" maxlength="40" title="소재지 주소를 입력해주세요"  ></td>
			  </tr>
