	...
	<div id="body">
		...
		<!-- 중간컨텐츠 : S -->
   		<div id="sub_contents"><a name="contents"></a>
			...
			<div id="con_head">
				<p class="position">
					<a href="../"><img src="../images/common/icon_home.gif" alt="HOME"></a> 원스톱민원센타 | 등록관리 | 공사업변경신고
				</p>
			</div>
			<!-- 현재위치 : E -->
			...
			<!-- 서브타이틀 : S -->
			<div id="sub_title">
				<h3 class="cont01"><img src="../01_one/images/titile_01_5.gif" alt="공사업 변경신고"></h1>
			</div>
			<!-- 서브타이틀 : E -->
			...
			<div id="contents">
			<!--서비스준비중 --><br><br>
				<p align="center"><img alt="서비스 준비중입니다." src="../images/common/service_ing.gif" /></p>
			</div>
		   	<!-- 컨텐츠 : E -->
