...
<!-- 자주가는 창구 이용방법 : S  -->
<h4><img src="../01_one/images/sub_title_02_1.gif" alt="자주가는 창구 이용방법" /></h4>
<p class="txt">
...
<!-- 자주가는 창구 관리 : S  -->
<h4><img src="../01_one/images/sub_title_02_2.gif" alt="회원탈퇴 관련사항" /></h4>
	<!-- 전체 : S  -->
	<div id="favorite_M">
		<!-- 사이트맵 : S  -->
		<div id="favorite_M_sitemap">
			<div class="center">
				<img src="../01_one/images/img_02_01.gif" alt="사이트맵 " />
			</div>
					...
					<table width="100%" height="180">
						<tr>
							<td valign="top"><div id="orgDiv"></div>						
								...
								var F_ONE_4 = F_ONE.addFolder(new Folder(treelist, 'F_ONE_4', 'MY 네트' ,data));
								...
								// MY 네트 아이템 : S
								data = {pid:'F_ONE_4_1', fav_url:'../mystore/MystoreAction.do?cmd=MyUseStore'};
								var F_ONE_4_1 = F_ONE_4.addItem(new Item(treelist, 'F_ONE_4_1', '내가 자주가는 창구', data));
								data = {pid:'F_ONE_4_2', fav_url:'../mem/MemAction.do?cmd=MemInfoV'};
								var F_ONE_4_2 = F_ONE_4.addItem(new Item(treelist, 'F_ONE_4_2', '개인정보 수정', data));
								data = {pid:'F_ONE_4_3', fav_url:'../mem/MemAction.do?cmd=MemPasswdChange'};
								var F_ONE_4_3 = F_ONE_4.addItem(new Item(treelist, 'F_ONE_4_3', '비밀번호 변경', data));
								data = {pid:'F_ONE_4_4', fav_url:'../mem/MemAction.do?cmd=MemMobileReg'};
								var F_ONE_4_4 = F_ONE_4.addItem(new Item(treelist, 'F_ONE_4_4', '모바일 서비스 사용 신청', data));
								data = {pid:'F_ONE_4_5', fav_url:'../mem/MemAction.do?cmd=MemCCReReg'};
								var F_ONE_4_5 = F_ONE_4.addItem(new Item(treelist, 'F_ONE_4_5', '공인인증서 재등록', data));
								data = {pid:'F_ONE_4_6', fav_url:'../mystore/MystoreAction.do?cmd=MySecede'};
								var F_ONE_4_6 = F_ONE_4.addItem(new Item(treelist, 'F_ONE_4_6', '회원탈퇴', data));
...
*/								// MY 민원창구 아이템 : E								
		...
		<div id="favorite_M_btn">
			<a href="javascript:removeMenu()"><img src="../01_one/images/img_02_del.gif" alt="삭제 " /></a>
		</div>


		<div id="favorite_M_my">
			<div class="center">
				<img src="../01_one/images/img_02_02.gif" alt="자주가는 창구 " />
			</div>
