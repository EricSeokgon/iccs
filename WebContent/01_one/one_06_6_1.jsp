	...
	<div id="body">
		...
		<!-- 중간컨텐츠 : S -->
   		<div id="sub_contents"><a name="contents"></a>
			...
			<!-- 서브타이틀 : S -->
			<div id="sub_title">
				<h3 class="cont01"><img src="../01_one/images/titile_06_6.gif" alt="회원탈퇴"></h3>
			</div>
			<!-- 서브타이틀 : E -->
   
		  	<!-- 컨텐츠 : S -->
	  	  	<div id="contents">
				<h4><img src="../01_one/images/sub_title_06_1.gif" alt="회원탈퇴안내" /></h4>
				<p class="txt">아래 회원탈퇴 관련사항을 확인하시고 회원탈최하기 버튼을 클릭하시면 회원탈퇴 처리가 완료됩니다.</p>
				<h4><img src="../01_one/images/sub_title_06_2.gif" alt="회원탈퇴 관련사항" /></h4>
				<div id="orange_650">
