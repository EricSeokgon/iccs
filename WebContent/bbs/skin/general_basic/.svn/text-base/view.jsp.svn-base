	      ...
	      <tr>
	       <td colspan="6"  class="td_view_title">
	       	<table width="100%" border="0" cellpadding="0" cellspacing="0">
	            ...
	            <td width="65%">
					  		<textarea name="COMMET" cols="50" rows="8" style='BORDER-BOTTOM-COLOR: #bfd8f2; 
					  				...
					  				onkeyup='javascript:commentCK(1000);' required="한줄 답변 내용을 입력해 주십시오"></textarea>
	            </td>
             	<td width="25%">
          	...
          	<tr><td colspan="3" width="100%" align="center">
	             		...
	             		<tr>
		                 	<td >※ 500자 이내</td>
		                 	<td >※ HTMLTAG 사용불가</td>
		                 	<td ><input type=text style="width:25px" name="commentcount" value="0" readonly>byte/1000 byte</td>
	                </tr>
	             </table>
	            </td></tr> 
         	</table>
