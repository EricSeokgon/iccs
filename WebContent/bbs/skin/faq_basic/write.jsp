...
<table width="670" border="0" cellspacing="0" cellpadding="0" align="center">
  				...
  				<tr>
    				<td>
						...
						<table width="670" border="0" cellspacing="0" cellpadding="0">
							...
							<tr>
						        <td width="80" align="center" class="td_view_title"><img src="../images/bbs/view_question.gif"></td>
						        <td class="td_view_detail">
									<input type="text" name="SUBJECT" class="input_bbs"  size="70" maxlength=80 value="<%=SUBJECT %>" required="질문을 입력하여 주세요!" maxbyte="200">
								</td>
						  	</tr>
								    		...
								    		<td class="td_view_detail">
								    			<table name="attachFile" id="attachFile" border="0" cellpadding="0" cellspacing="0">
									            	...
									            	<input type="hidden" NAME="fileCnt" VALUE="1">
									          		...
									          		<tr>			              	
									                	<td><input type="file" class="input_bbs"  name="BBS_FILE" size=50 ></td>
							...
							<!-- ======================= 첨부파일 일력필드 END ===================== -->
      						...
      						<tr>
        						<td width="80" align="center" class="td_view_title"><img src="../images/bbs/view_answer.gif"></td>
        						<td class="td_view_detail">
									<%
  	...
  	<tr> 
    	<td align="right">
			...
			<img src="../images/bbs/btn_ok.gif" width="46" height="19" border="0" alt="확인" onClick="fn_dxtsave('<%=cmd%>')" style="cursor:pointer">
		    <% } %>
