...
function movie(value, width, height){	//????AICA????????
...
*/		
		...
		location.href="../07_service/service_03_1.jsp";
		...
		location.href="../09_center/center_01_1.jsp";		
	} else if(menuName=="m91") { 
		location.href="../09_center/center_01_1.jsp";		
	} else if(menuName=="m911") { 
		location.href="../09_center/center_01_1.jsp";		
	} else if(menuName=="m912") { 
		location.href="../bbs/BbsAction.do?cmd=BbsKList&CT_ID=QNA_LOCAL_PUB";		
	} else if(menuName=="m913") { 
		location.href="../bbs/BbsAction.do?cmd=BbsKList&CT_ID=PDA_LOCAL_PUB";
		
	} else if(menuName=="m92") { 
		location.href="../bbs/BbsAction.do?cmd=BbsKList&CT_ID=USE_SIDO_PUB";		
	} else if(menuName=="m921") { 
		location.href="../bbs/BbsAction.do?cmd=BbsKList&CT_ID=USE_SIDO_PUB";		
	} else if(menuName=="m922") { 
		location.href="../bbs/BbsAction.do?cmd=BbsKList&CT_ID=DESIGN_SIDO_PUB";		
	} else if(menuName=="m923") { 
		location.href="../bbs/BbsAction.do?cmd=BbsKList&CT_ID=PDA_SIDO_PUB";
		
	} else if(menuName=="m93") { 
		location.href="../bbs/BbsAction.do?cmd=BbsKList&CT_ID=USE_SIGUNGU_PUB";		
	} else if(menuName=="m931") { 
		location.href="../bbs/BbsAction.do?cmd=BbsKList&CT_ID=USE_SIGUNGU_PUB";		
	} else if(menuName=="m932") { 
		location.href="../bbs/BbsAction.do?cmd=BbsKList&CT_ID=DISIGN_SIGUNGU_PUB";		
	} else if(menuName=="m933") { 
		location.href="../bbs/BbsAction.do?cmd=BbsKList&CT_ID=PDA_SIGUNGU_PUB";		

	} else if(menuName=="m94") { 
		location.href="../09_center/center_04_1.jsp";
	} else if(menuName=="m941") { 
		location.href="../09_center/center_04_1.jsp";		
	} else if(menuName=="m942") { 
		location.href="../bbs/BbsAction.do?cmd=BbsKList&CT_ID=QNA_LEGAL_PUB";		
	} else if(menuName=="m943") { 
