...
public class KJFUtil {
	 ...
	 * @return Vector
	 */
	public static Vector<KJFSelect> makeSelect (String[] selItem){

		Vector<KJFSelect> vec = new Vector<KJFSelect>();
     ...
     * @return Vector
     */
    public static Vector<KJFSelect> makeCategorySelect (String[] selItem) {
     ...
     * @return Vector
     */
    public static Vector<KJFSelect> makeCategory (String[] selItem) {
	 ...
	 * @return Vector
	 */
    public static Vector<KJFSelect> getSelPageLine(){
     ...
     * @return Vector
     */
    public static Vector<KJFSelect> getSelCafePageLine(){
     ...
     * @return Vector
     */
    public static Vector<KJFSelect> getSelNewDay(){
    ...
    */
     ...
     * @throws Exception
     */
    public static String getTempNum(int length) {
	...
	public static String HttpPost2(String hostname, String path, int port, String data) throws  Exception{ 
	    ...
	    String uri = "http://"+hostname+":"+port+path; 
