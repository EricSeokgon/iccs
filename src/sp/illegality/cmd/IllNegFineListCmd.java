...
/***************************************************************************
 * <p>Title       : IllNegligenceFineCmd Class</p>
 * <p>Description : 과태료부과 리스트 클래스</p>
 * <p>Copyright   : Copyright(c) 2007 PKT. All rights reserved.</p>
 * 
 * NOTE : 과태료부과 리스트 처리를 한다. 
 * 
 * @version 1.0
 * @author  PKT
 **************************************************************************/
public class IllNegFineListCmd implements KJFCommand {
    
    UserEnt user;
    
    public IllNegFineListCmd() {        
    }
    ...
    public void loadData(HttpServletRequest request, IllegalityParam pm) throws Exception {
        ...
        sbSQL.append("        PT_N.NEFI,                        \n");   // 과태료
        sbSQL.append("        PT_N.PAY_LIM,                     \n");   // 납부기한
        ...
        sbSQL.append("               SELECT TMP_WRT_NUM, WRT_NUM, NEFI, PAY_LIM, PAY_DT, PAY_YN     \n");   
        sbSQL.append("                 FROM PT_M_NEGLIGENCE                                         \n");  
        sbSQL.append("              ) PT_N ON PT_M.TMP_WRT_NUM = PT_N.TMP_WRT_NUM                   \n");
        sbSQL.append("                    AND PT_M.WRT_NUM = PT_N.WRT_NUM                           \n");
        ...
        sbCntSQL.append("                 FROM PT_M_NEGLIGENCE                              \n");  
        sbCntSQL.append("              ) PT_N ON PT_M.TMP_WRT_NUM = PT_N.TMP_WRT_NUM        \n");
        sbCntSQL.append("                    AND PT_M.WRT_NUM = PT_N.WRT_NUM                \n");
