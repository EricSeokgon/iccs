...
/***************************************************************************
 * <p>Title       : IllBusiSuspensionCmd Class</p>
 * <p>Description : 영업정지 상세 클래스</p>
 ...
 * @author  PKT
 **************************************************************************/
public class IllBusiSusViewCmd implements KJFCommand {
    
    UserEnt user;
    
    public IllBusiSusViewCmd() {        
    }
    ...
    public void loadData(HttpServletRequest request, IllegalityParam pm) throws Exception {
        ...
        sbSQL.append("   FROM (PT_M_MASTER PT_M INNER JOIN PT_M_SUSPENSION PT_S     \n");
