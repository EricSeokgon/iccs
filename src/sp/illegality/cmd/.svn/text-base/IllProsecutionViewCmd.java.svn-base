 ...
 * <p>Description : 형사고발 상세 클래스</p>
 * <p>Copyright   : Copyright(c) 2007 PKT. All rights reserved.</p>
 * 
 * NOTE : 형사고발 상세 정보 처리를 한다. 
 * 
 * @version 1.0
 * @author  PKT
 **************************************************************************/
public class IllProsecutionViewCmd implements KJFCommand {
        
    public IllProsecutionViewCmd() {        
    }
    ...
    public void loadData(HttpServletRequest request, IllegalityParam pm) throws Exception {
        ...
        sbSQL.append("   FROM (PT_M_MASTER PT_M INNER JOIN PT_M_PROSECUTION PT_P   \n");
        sbSQL.append("     ON RTRIM(PT_M.TMP_WRT_NUM) = PT_P.TMP_WRT_NUM        \n");
