 ...
 * <p>Description : 과태료부과 상세정보 클래스</p>
 * <p>Copyright   : Copyright(c) 2007 PKT. All rights reserved.</p>
 * 
 * NOTE : 과태료부과 상세정보 처리를 한다. 
 * 
 * @version 1.0
 * @author  PKT
 **************************************************************************/
public class IllNegFineViewCmd implements KJFCommand {
    
    UserEnt user;
    
    public IllNegFineViewCmd() {        
    }
    ...
    public void loadData(HttpServletRequest request, IllegalityParam pm) throws Exception {
        ...
        sbSQL.append("   FROM (PT_M_MASTER PT_M INNER JOIN PT_M_NEGLIGENCE PT_N     \n");
        sbSQL.append("     ON RTRIM(PT_M.TMP_WRT_NUM) = PT_N.TMP_WRT_NUM            \n");
