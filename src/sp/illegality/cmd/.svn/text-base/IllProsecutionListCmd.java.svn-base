...
/***************************************************************************
 * <p>Title       : IllProsecutionCmd Class</p>
 * <p>Description : 형사고발 리스트 클래스</p>
 * <p>Copyright   : Copyright(c) 2007 PKT. All rights reserved.</p>
 * 
 * NOTE : 형사고발 리스트 정보 처리를 한다. 
 * 
 * @version 1.0
 * @author  PKT
 **************************************************************************/
public class IllProsecutionListCmd implements KJFCommand {
    
    UserEnt user;
    
    public IllProsecutionListCmd() {        
    }
    ...
    public void loadData(HttpServletRequest request, IllegalityParam pm) throws Exception {
        ...
        sbSQL.append("        PT_P.PRSEC_PART,                  \n");   // 고발처
        sbSQL.append("        PT_P.PRSEC_CONT,                  \n");   // 고발내용
        sbSQL.append("        PT_P.PRSEC_DT,                    \n");   // 고발일자
        ...
        sbSQL.append("               SELECT TMP_WRT_NUM, WRT_NUM, PRSEC_DT,         \n");   
        sbSQL.append("                      PRSEC_CONT, PRSEC_PART                  \n");
        sbSQL.append("                 FROM PT_M_PROSECUTION                        \n");  
        sbSQL.append("              ) PT_P ON PT_M.TMP_WRT_NUM = PT_P.TMP_WRT_NUM   \n");
        sbSQL.append("                    AND PT_M.WRT_NUM = PT_P.WRT_NUM           \n");
        ...
        sbCntSQL.append("                 FROM PT_M_PROSECUTION                         \n");  
        sbCntSQL.append("              ) PT_P ON PT_M.TMP_WRT_NUM = PT_P.TMP_WRT_NUM    \n");
        sbCntSQL.append("                    AND PT_M.WRT_NUM = PT_P.WRT_NUM            \n");
