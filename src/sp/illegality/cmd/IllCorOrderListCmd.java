 ...
 * @author  PKT
 **************************************************************************/
public class IllCorOrderListCmd implements KJFCommand {
    
    UserEnt user;
    
    public IllCorOrderListCmd() {        
    }
    ...
    public void loadData(HttpServletRequest request, IllegalityParam pm) throws Exception {
        ...
        sbSQL.append("               SELECT TMP_WRT_NUM, WRT_NUM, CORRECT_ORDER_CONT,       \n");   
        sbSQL.append("                      CORRECT_ORDER_START_DT, CORRECT_ORDER_END_DT    \n");       
        sbSQL.append("                 FROM PT_M_CORRECT                                    \n");  
        sbSQL.append("              ) PT_CO ON PT_M.TMP_WRT_NUM = PT_CO.TMP_WRT_NUM         \n");
        ...
        sbCntSQL.append("                 FROM PT_M_CORRECT                                 \n");  
        sbCntSQL.append("              ) PT_CO ON PT_M.TMP_WRT_NUM = PT_CO.TMP_WRT_NUM      \n");
        sbCntSQL.append("                     AND PT_M.WRT_NUM = PT_CO.WRT_NUM              \n");
