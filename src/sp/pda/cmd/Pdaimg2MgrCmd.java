 ...
 * @author  PKT
 **************************************************************************/
public class Pdaimg2MgrCmd implements KJFCommand {
    
    public Pdaimg2MgrCmd() {
    ...
    public void loadData(HttpServletRequest request, PdaParam pm) throws Exception {
        ...
        selectSQL.append("SELECT OFFSEAL  		\n");
        
        fromSQL.append("  FROM PT_MI_USER    \n");
       
      whereSQL.append("  WHERE	SIDO_CODE ='"+SIDO_CODE+"'  \n");
      whereSQL.append("    AND	SIGUNGU_CODE ='"+GUGUN+"'  \n");
      whereSQL.append("    AND	OFFI_ID ='"+id+"'  \n");
