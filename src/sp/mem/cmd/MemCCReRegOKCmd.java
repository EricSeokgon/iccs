...
/****************************************************************************
 * <p>Title       : MemCCReRegOKCmd Class</p>
 * <p>Description : 공인인증 재등록 성공 처리 클래스</p>
 * <p>Copyright   : Copyright(c) 2007 PKT. All rights reserved.</p>
 *
 * NOTE : 공인인증 재등록 성공 처리를 한다.
 *
 * @version 1.0
 * @author  PKT
 ***************************************************************************/
public class MemCCReRegOKCmd implements KJFCommand {
    
    UserEnt user;
    
    public MemCCReRegOKCmd() {        
    }
