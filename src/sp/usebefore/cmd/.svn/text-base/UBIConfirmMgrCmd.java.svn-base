...
//            
//	        String sOFFI_ID = user.getUSER_ID();
//	        
...
//	    			String admNum = rEntity.getValue(0, "RECV_NUM");
...
//     * @throws Exception
//     */
//    private String setAttachFile(UseBaseParam pm) throws Exception{
//    	StringBuffer content = new StringBuffer();
//    	
//    	content.append("<html>\n");
//        content.append("	<head>\n");
