 ...
 * @author  PKT
 **************************************************************************/
public class UseBeforeMgrResCUDCmd implements KJFCommand {
    
	UserEnt user;
	private int smsre = 2;
	
    public UseBeforeMgrResCUDCmd() {
    ...
    public String execute(HttpServletRequest request, ActionForm form) throws Exception {        
        ...
        request.setAttribute("cmd", "UseBeforeMgrResC");
        return "/usebefore/UseBeforeAction.do?cmd=UseBeforeMgrResC&scRECV_NUM="+pm.getScRecv_num(); 
