...
public class StatusEnt {
    ...
    private boolean PUBLIC_DIV_YN = false;  // 공무원전용게시판 사용 유무
	...
	public boolean isPUBLIC_DIV_YN() {
		return PUBLIC_DIV_YN;
	}


	public void setPUBLIC_DIV_YN(boolean public_div_yn) {
		PUBLIC_DIV_YN = public_div_yn;
	}
